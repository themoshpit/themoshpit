...
let pdata = {
	...
	*/
	...
	'marvindakid': {
		...
		+ 'by XXXTentacion, Drake, 2Pac, Ski Mask The Slump God, and Lil Yachty. MDK started rapping ' 
		+ 'at the age of seven but never wrote his own lyrics, taking them from YouTube comments. He '
		+ 'started to finally write and record at the age of 13 not taking rapping seriously. He used '
		+ 'to go by "The Remix" for his passion of remixing songs by Drake, Lil Yachty, Lil Uzi Vert, and '
		+ 'more. At the age of 14 he finally took rapping seriously to talk about him and his thoughts but '
		+ 'also for fun. "If I do ever blow and go mainstream I want to help out everyone who supported me '
		+ 'from the start. I\'d never switch up on my brodies and I\'d always keep it real with them." His '
		+ 'plans are to get more money and move into a two story home with one of his groups, "The Moshpit" '
		+ 'which was created in their Sophomore year. When he gets more money he plans to get better equipment '
		+ 'and expand his music into different parts of the world and different people, following the footsteps '
		+ 'of XXXTentacion. "I want to improve more and more with my music. If I become famous and stay famous I '
		+ 'want to be remembered not just for being a rapper. I want to be remembered for being like anyone else... '
		+ 'A person. Everyone gets things on their mind they want to say, but would be too afraid to say... I want to '
		+ 'be that voice. I\'m not the best looking guy, but I know there is others like me that want to do great '
		+ 'things. I want and need to be someone that\'s different from everyone else. My desire is to standout."', // Write About Yourself
		pictureUrl: 'none', // The Picture That Will Be Displayed
			// On Your Profile, Put none For No Picture
